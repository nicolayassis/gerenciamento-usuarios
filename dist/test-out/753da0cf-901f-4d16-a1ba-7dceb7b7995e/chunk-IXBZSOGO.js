...
var init_adicionar_usuarios = __esm({
  "angular:jit:template:src\\app\\components\\adicionar-usuarios\\adicionar-usuarios.html"() {
    adicionar_usuarios_default = `<h2>{{ idEdicao ? 'Editar Usu\xE1rio' : 'Adicionar Usu\xE1rio' }}</h2>\r
<button (click)="menuInicial()">Menu Inicial</button>\r
<form [formGroup]="form" (ngSubmit)="salvar()" class="form">\r
  <label>\r
    <span>Nome</span>\r
    <input type="text" formControlName="nome" />\r
  </label>\r
\r
  <div class="alert" *ngIf="form.get('nome')?.touched && form.get('nome')?.invalid">\r
    <ng-container *ngIf="form.get('nome')?.errors?.['required']">\r
      \u26A0\uFE0F Nome \xE9 obrigat\xF3rio.\r
    </ng-container>\r
\r
    <ng-container *ngIf="form.get('nome')?.errors?.['minlength']">\r
      \u26A0\uFE0F Nome deve ter no m\xEDnimo 3 caracteres.\r
    </ng-container>\r
\r
    <ng-container *ngIf="form.get('nome')?.errors?.['pattern']">\r
      \u26A0\uFE0F O nome n\xE3o pode conter n\xFAmeros ou caracteres especiais.\r
    </ng-container>\r
  </div>\r
\r
  <label>\r
...
\r
  <div class="alert" *ngIf="form.get('email')?.touched && form.get('email')?.invalid">\r
    \u26A0\uFE0F Informe um e-mail v\xE1lido.\r
  </div>\r
\r
  <label>\r
    <span>Idade (opcional)</span>\r
    <input type="number" formControlName="idade" />\r
  </label>\r
\r
  <div class="alert" *ngIf="form.get('idade')?.touched && form.get('idade')?.invalid">\r
    \u26A0\uFE0F Idade deve ser 18 ou mais.\r
  </div>\r
\r
  <div class="botoes">\r
    <button type="submit" [disabled]="form.invalid">Salvar</button>\r
    <button type="button" class="sec" (click)="router.navigate(['/usuarios'])">Cancelar</button>\r
  </div>\r
</form>\r
...
var init_adicionar_usuarios3 = __esm({
  "src/app/components/adicionar-usuarios/adicionar-usuarios.ts"() {
    ...
    AdicionarUsuariosComponent = class AdicionarUsuariosComponent2 {
      ...
      // Agora `fb` já existe quando este campo é avaliado
      form = this.fb.group({
        ...
        // opcional: number | null com validação de mínimo
...
var init_home_component = __esm({
  "angular:jit:template:src\\app\\components\\home\\home.component.html"() {
    home_component_default = '<!-- Menu horizontal -->\r\n<nav class="main-nav">\r\n  <mat-toolbar color="primary">\r\n    <span>Gerenciamento de Funcion\xE1rios - Sistema IRIS</span>\r\n    <span class="spacer"></span>\r\n    <button mat-button color="primary" routerLink="/usuarios">\r\n      <mat-icon>list</mat-icon> Listar Usu\xE1rios\r\n    </button>\r\n    <button mat-button color="accent" routerLink="/adicionar">\r\n      <mat-icon>person_add</mat-icon> Adicionar Usu\xE1rios\r\n    </button>\r\n  </mat-toolbar>\r\n</nav>\r\n\r\n<!-- Imagem logo abaixo do menu -->\r\n<div class="menu-image">\r\n\r\n   <img src="/IRIS.jpg" alt="Banner">\r\n</div>\r\n\r\n<!-- Conte\xFAdo das rotas -->\r\n<div class="content">\r\n  <router-outlet></router-outlet>\r\n</div>\r\n';
  }
});
...
var init_home_component2 = __esm({
  "angular:jit:style:src\\app\\components\\home\\home.component.css"() {
    home_component_default2 = "/* src/app/components/home/home.component.css */\n.main-nav {\n  width: 100%;\n}\n.spacer {\n  flex: 1 1 auto;\n}\n.menu-image {\n  margin: 20px 0;\n  text-align: center;\n}\n.menu-image img {\n  max-width: 80%;\n  height: auto;\n  border-radius: 10px;\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2);\n}\n.content {\n  padding: 20px;\n}\n/*# sourceMappingURL=home.component.css.map */\n";
  }
});
...
var HomeComponent_1, _a, HomeComponent;
var init_home_component3 = __esm({
  "src/app/components/home/home.component.ts"() {
    ...
    HomeComponent = (_a = class {
      ...
      itensMenu = [
        { label: "home", link: HomeComponent_1 },
        { label: "adicionar-usuarios", route: AdicionarUsuariosComponent },
        { label: "listar-usuario", route: ListaUsuariosComponent }
      ];
      adicionarUsuario() {
        this.router.navigate(["/adicionar"]);
      }
    }, HomeComponent_1 = _a, __publicField(_a, "ctorParameters", () => [
      { type: Router }
    ]), _a);
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-IXBZSOGO.js.map
